...
require_once 'AppConfig_unbind.php';
...
function agreesms(){
    ...
    $params = array();
    $params["cusid"] = AppConfig_unbind::CUSID;
    $params["appid"] = AppConfig_unbind::APPID;
    $params["version"] = AppConfig_unbind::APIVERSION;
    $params["orderid"] = $orderid;
    $params["randomstr"] ='12';
    $params["signtype"] ='RSA';
    $params["sign"] = urlencode(AppUtil::Sign($params));//签名
    $paramsStr = AppUtil::ToUrlParams($params);
    $url = AppConfig_unbind::APIURL . "/paysmsagree";
